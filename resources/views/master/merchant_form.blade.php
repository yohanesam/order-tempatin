...
@section('content')
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div class="clearfix">
                                            <div class="pull-left"><a id="tambah-setup" href="#modal-tambah-form" data-toggle="modal" class="btn btn-white btn-info btn-bold"> <i class="fa fa-plus"></i> Tambah Formulir</a></div>
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
                                                    ...
                                                    <tr>
														...
														<td>
															@foreach($user as $merchant)
																@if($merchant->id_user==$item->user_id)
																	{{$merchant->email}}
																@endif
															@endforeach
														</td>
														<td>
															{{$item->status_formulir}}
														</td>
														<td>{{$item->updated_at}}</td>
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="green" href="#modal-tambah-form" id="ubah-setup-{{$item->id_form}}" data-toggle="modal" >
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>

																<a class="red" href="{{route('del.form',$item->id_form)}}">
                                                            ...
                                                            <script>
                                                                $("#ubah-setup-{{$item->id_form}}").click(function(){
                                                                    var file="{{asset(str_replace('\\', '/', $item->gambar_setup))}}";
                                                                    $('h4').text('Ubah Formulir');
                                                                    $('form').removeAttr('action');
                                                                    $('form').attr('action', '{{route("up.form",$item->id_form)}}');
                                                                    $('#form-field-user').val('{{$item->user_id}}');
                                                                    $('#form-field-nama-form').val('{{$item->nama_formulir}}');
                                                                    $('#form-field-nama-data').val('{{$item->nama_data}}');
                                                                    $('#form-field-status').val('{{$item->status_formulir}}');
																	var form = '{{$item->id_form}}';
																	
																	$.ajax({
																		type : 'GET',
																		url : '{{url("api/form/detail")}}/'+form,
																		success: function (data) {
																			
																			//jika data berhasil didapatkan, tampilkan ke dalam option select kabupaten
																			$("#form-field-detail").html(data);
																		}
																	});
                                                                });
                                                            </script>
                                        ...
                                        <script>
                                            $("#tambah-setup").click(function(){
                                                $('h4').text('Tambah Formulir');
                                                $('form').removeAttr('action');
                                                $('form').attr('action', '{{route("create.form")}}');
                                                $('form').trigger("reset");
                                                ...
                                                <div class="modal-content">
                                                    <form id="form-kolom" action="{{route('create.form')}}" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-header">
                                                            ...
                                                            <h4 class="blue bigger">Tambah Formulir</h4>
                                                        </div>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                <div class="col-xs-12 col-sm-5">
                                                                    <div class="form-group">
                                                                        <label for="form-field-nama">Pemilik Formulir</label>
                                                            ...
                                                            <div class="row">
																...
																<div class="col-xs-12 col-sm-4">
                                                                    <div class="form-group">
                                                                        <label for="form-field-status">Status Formulir</label>

                                                                        <div>
                                                                            <select name="status_formulir" id="form-field-status">
																				<option value="draft">Draft</option>
																				<option value="publish">Pubilsh</option>
																			</select>
                                                                        </div>
                                                                    </div>
																</div>
                                                                <div class="col-xs-12 col-sm-12 mt-repeater">
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				/////////
				$('#modal-tambah-form input[type=file]').ace_file_input({
					style:'well',
					btn_choose:'Taruh file atau Klik disini untuk Upload Gambar Setup',
					btn_change:null,
					no_icon:'ace-icon fa fa-cloud-upload',
				...
				$('#modal-tambah-form').on('shown.bs.modal', function () {
					if(!ace.vars['touch']) {
